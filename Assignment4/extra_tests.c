...
// test methods
static void extraTestInsertAndFind(void);
static void extraTestIndexScan (void);
// helper methods
...
main (void) 
{
  ...
  extraTestInsertAndFind(); //Different node size
  extraTestIndexScan();   //Different node size
...
extraTestInsertAndFind (void)
{
  ...
  TEST_CHECK(createBtree("testidx", DT_INT, 4));
